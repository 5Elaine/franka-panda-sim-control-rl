...
class CartesianApproach(Node):
    def __init__(self) -> None:
        super().__init__("cartesian_near_grasp")
    ...
    def compute_path(self):
        ...
        waypoint.position.x = 0.55
        waypoint.position.y = 0.00
        waypoint.position.z = 0.455
        ...
        self.get_logger().info(
            "Computing collision-aware Cartesian path to "
            "(0.55, 0.00, 0.455) m..."
        )
